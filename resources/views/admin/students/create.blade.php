                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="{{route('students.store')}}" id="studentsForm" enctype="multipart/form-data" method="POST">
                                            @csrf
                                            <div class="row">   
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label class="form-label">Name @error('name') <span class="text-danger"> {{ $message }} </span> @enderror</label>
                                                        <input type="text" name="name" maxlength="100" value="{{old('name')}}" class="form-control" placeholder="Enter client name">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" name="phone" maxlength="10" value="{{old('phone')}}" class="form-control" placeholder="Enter phone number">
                                                    </div>
                                                </div>
