                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center" data-kt-subscription-table-toolbar="base">
                                            ...
                                            <a href="{{ route('students.create') }}" class="btn btn-primary btn-rounded waves-effect waves-light mb-2 me-2"><i class="mdi mdi-plus me-1"></i> Add Student</a>
                                        </div>
                                                ...
                                                <td>
                                                    <ul class="list-unstyled hstack gap-1 mb-0">
                                                        <li data-bs-toggle="tooltip" data-bs-placement="top" title="Edit">
                                                            <a href="{{route('students.edit', $student->id)}}" class="btn btn-sm btn-soft-warning"><i class="mdi mdi-pencil-outline"></i></a>
                                                        </li>
                                                        ...
                                                        @if($student->status ==0)
                                                        <li data-bs-toggle="tooltip" data-bs-placement="top" title="Active">
                                                            <a href="{{route('students.show', $student->id)}}" class="btn btn-sm btn-soft-primary"><i class="bx bx-toggle-left"></i></a>
                                                        </li>
                                                        @else
                                                        <li data-bs-toggle="tooltip" data-bs-placement="top" title="Inactive">
                                                            <a href="{{route('students.show', $student->id)}}" class="btn btn-sm btn-soft-secondary"><i class="bx bx-toggle-right"></i></a>
                                                        </li>
                                                        @endif
                                                    </ul>
                                                </td>
